...
const OPTIONS = [
  ...
  },
  {
    href: "/matchup",
    emoji: "📅",
    title: "Matchup Planner",
    description: "Project your head-to-head matchup result for this week using per-game averages.",
  },
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)] flex flex-col items-center justify-start pt-2 sm:justify-center sm:pt-1 px-4">
      {/* Logo + tagline */}
